        ...
        <div className="flex gap-4">
          ...
          <div className={`relative flex-shrink-0 overflow-hidden shadow-inner ring-1 ring-black/5 ${hasImage ? "h-20 w-20 rounded-2xl" : "h-14 w-14 rounded-full"}`}>
            {hasImage ? (
              ...
              <div className="relative h-full w-full overflow-hidden bg-gradient-to-br from-blue-950 via-slate-800 to-slate-900 rounded-full">
                <div className="absolute inset-0 bg-gray-200 opacity-20 mix-blend-normal  rounded-full"></div>
