  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-gradient-to-b from-blue via-blue to-blue-dark p-4 sm:p-8 text-white select-none">
      ...
      <main className="relative z-10 flex w-full max-w-md flex-col justify-center rounded-none bg-transparent p-2 sm:rounded-3xl sm:border sm:border-white/10 sm:bg-white/5 sm:p-8 sm:shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] sm:backdrop-blur-md">
        <div className="relative z-10 mb-4 flex flex-col items-center text-center w-full">
          <TiltCard maxRotation={8} scale={1.02} className="mb-4 w-full">
            <div className="w-full overflow-hidden rounded-2xl bg-white p-4 shadow-xl border border-white/20 select-none flex items-center justify-center">
              <img src="/og-image.png" alt="SETUH — Connecting People, Fulfilling Needs" className="w-full h-auto object-contain rounded-lg" />
            </div>
          </TiltCard>
